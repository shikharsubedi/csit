...
$config['attr_last_item'] = array('class' => 'active');
/**
 * ------------------------
 * Config: unlink home
 * ------------------------
 ...
 */
$config['replacer'] = array('control'	=>	'Dashboard');
 ...
 */
$config['exclude'] = array('module','articles','category','page','vacancy','dashboard');
 ...
 */
$config['strip_characters'] = array('_', '.html', '.php', '.htm','.cfm');
