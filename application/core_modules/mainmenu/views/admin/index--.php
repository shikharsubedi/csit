            ...
            <form name="update-main-menu" id="update-main-menu" method="post" action="">
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td align="right" width="10%"><input type="hidden" name="token_id" value="<?php echo $tokenId?>" /><input type="submit" value="Save" class="button" id="save_menu" style="display:none;"/></td>
                    </tr>
                </table>
            </form>
...
//var menuCount = $('ol.sortable').children('li').length;
    ...
    $(function () {
        ...
        <?php /*?>$('#add_brand').click(function (e) {
            e.preventDefault();
            var _selected = $('.select_brand:checked');
            ...
            _selected.each(function (i) {
                ...
                var _id = menuCount++,
                        _order = $('input.order').length;
                _content_ref = $(this).val();
                var _newElem = $('<li id="menuitem-' + _id + '"><div>' + label + ' ( Brand )<span class="item-control"></span></div>'
                        + '<div class="menu_controls">'
                        + '<p>Label</p>'
                        + '<p><input type="text" name="menulabel[label-' + _id + ']" class="regular-text" value="' + label + '" />'
                        + '<p>Top Menu?</p>'
                        + '<p><input type="checkbox" name="topmenu[label-' + _id + ']" class="regular-text" value="Y" />'
                        + '<input type="hidden" name="menutype[label-' + _id + ']" value="<?php echo mainmenu\models\Mainmenu::MAINMENU_TYPE_BRAND ?>" />'
                        + '<input type="hidden" name="reference[label-' + _id + ']" value="' + _content_ref + '" />'
                        + '<p><input type="hidden" name="order[label-' + _id + ']" class="order" value="' + _order + '" />'
                        + '</p><p><a href="#" class="remove_menuitem">Remove</a></p></div></li>');
                _newElem.appendTo('ol.sortable');
        ...
        $('#add_product').click(function (e) {
            e.preventDefault();
            var _selected = $('.select_product:checked');
            ...
            _selected.each(function (i) {
                ...
                var _id = menuCount++,
                        _order = $('input.order').length;
                _content_ref = $(this).val();
                var _newElem = $('<li id="menuitem-' + _id + '"><div>' + label + ' ( Product )<span class="item-control"></span></div>'
                        + '<div class="menu_controls">'
                        + '<p>Label</p>'
                        + '<p><input type="text" name="menulabel[label-' + _id + ']" class="regular-text" value="' + label + '" />'
                        + '<p>Top Menu?</p>'
                        + '<p><input type="checkbox" name="topmenu[label-' + _id + ']" class="regular-text" value="Y" />'
                        + '<input type="hidden" name="menutype[label-' + _id + ']" value="<?php echo mainmenu\models\Mainmenu::MAINMENU_TYPE_PRODUCT ?>" />'
                        + '<input type="hidden" name="reference[label-' + _id + ']" value="' + _content_ref + '" />'
                        + '<p><input type="hidden" name="order[label-' + _id + ']" class="order" value="' + _order + '" />'
                        + '</p><p><a href="#" class="remove_menuitem">Remove</a></p></div></li>');
                _newElem.appendTo('ol.sortable');
        ...
        $('#add_categories').click(function (e) {
            ...
            _selected.each(function (i) {
                ...
                var _id = menuCount++,
                        _order = $('input.order').length;
                _content_ref = $(this).val();
                var _newElem = $('<li id="menuitem-' + _id + '"><div>' + label + ' ( Package Type )<span class="item-control"></span></div>'
                        + '<div class="menu_controls">'
                        + '<p>Label</p>'
                        + '<p><input type="text" name="menulabel[label-' + _id + ']" class="regular-text" value="' + label + '" />'
                        + '<p>Top Menu?</p>'
                        + '<p><input type="checkbox" name="topmenu[label-' + _id + ']" class="regular-text" value="Y" />'
                        + '<input type="hidden" name="menutype[label-' + _id + ']" value="<?php echo mainmenu\models\Mainmenu::MAINMENU_TYPE_PACKAGETYPE ?>" />'
                        + '<input type="hidden" name="reference[label-' + _id + ']" value="' + _content_ref + '" />'
                        + '<p><input type="hidden" name="order[label-' + _id + ']" class="order" value="' + _order + '" />'
                        + '</p><p><a href="#" class="remove_menuitem">Remove</a></p></div></li>');
                _newElem.appendTo('ol.sortable');
        ...
        $('#add_package').click(function (e) {
            ...
            _selected.each(function (i) {
                ...
                var _id = menuCount++,
                        _order = $('input.order').length;
                _content_ref = $(this).val();
                var _newElem = $('<li id="menuitem-' + _id + '"><div>' + label + ' ( Package )<span class="item-control"></span></div>'
                        + '<div class="menu_controls">'
                        + '<p>Label</p>'
                        + '<p><input type="text" name="menulabel[label-' + _id + ']" class="regular-text" value="' + label + '" />'
                        + '<p>Top Menu?</p>'
                        + '<p><input type="checkbox" name="topmenu[label-' + _id + ']" class="regular-text" value="Y" />'
                        + '<input type="hidden" name="menutype[label-' + _id + ']" value="<?php echo mainmenu\models\Mainmenu::MAINMENU_TYPE_PACKAGE ?>" />'
                        + '<input type="hidden" name="reference[label-' + _id + ']" value="' + _content_ref + '" />'
                        + '<p><input type="hidden" name="order[label-' + _id + ']" class="order" value="' + _order + '" />'
                        + '</p><p><a href="#" class="remove_menuitem">Remove</a></p></div></li>');
                _newElem.appendTo('ol.sortable');
        ...
        $('#add_activity').click(function (e) {
            ...
            _selected.each(function (i) {
                ...
                var _id = menuCount++,
                        _order = $('input.order').length;
                _content_ref = $(this).val();
                var _newElem = $('<li id="menuitem-' + _id + '"><div>' + label + ' ( Activity )<span class="item-control"></span></div>'
                        + '<div class="menu_controls">'
                        + '<p>Label</p>'
                        + '<p><input type="text" name="menulabel[label-' + _id + ']" class="regular-text" value="' + label + '" />'
                        + '<p>Top Menu?</p>'
                        + '<p><input type="checkbox" name="topmenu[label-' + _id + ']" class="regular-text" value="Y" />'
                        + '<input type="hidden" name="menutype[label-' + _id + ']" value="<?php echo mainmenu\models\Mainmenu::MAINMENU_TYPE_ACTIVITY ?>" />'
                        + '<input type="hidden" name="reference[label-' + _id + ']" value="' + _content_ref + '" />'
                        + '<p><input type="hidden" name="order[label-' + _id + ']" class="order" value="' + _order + '" />'
                        + '</p><p><a href="#" class="remove_menuitem">Remove</a></p></div></li>');
                _newElem.appendTo('ol.sortable');
        ...
        $('#add_destination').click(function (e) {
            ...
            _selected.each(function (i) {
                ...
                var _id = menuCount++,
                        _order = $('input.order').length;
                _content_ref = $(this).val();
                var _newElem = $('<li id="menuitem-' + _id + '"><div>' + label + ' ( Destination )<span class="item-control"></span></div>'
                        + '<div class="menu_controls">'
                        + '<p>Label</p>'
                        + '<p><input type="text" name="menulabel[label-' + _id + ']" class="regular-text" value="' + label + '" />'
                        + '<p>Top Menu?</p>'
                        + '<p><input type="checkbox" name="topmenu[label-' + _id + ']" class="regular-text" value="Y" />'
                        + '<input type="hidden" name="menutype[label-' + _id + ']" value="<?php echo mainmenu\models\Mainmenu::MAINMENU_TYPE_DESTINATION ?>" />'
                        + '<input type="hidden" name="reference[label-' + _id + ']" value="' + _content_ref + '" />'
                        + '<p><input type="hidden" name="order[label-' + _id + ']" class="order" value="' + _order + '" />'
                        + '</p><p><a href="#" class="remove_menuitem">Remove</a></p></div></li>');
                _newElem.appendTo('ol.sortable');
