...
<div class="content"><form method="post" action="" name="frm_ad_news" id="frm_ad_news" enctype="multipart/form-data">
        <table class="form-table">
            ...
            <tr valign="top">
                ...
                <td><input name="content_image" id="content_image" type="file" size="255" value="<?php echo set_value('content_image') ?>"  autocomplete="off" style="width:80%" /></td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td><select name="content_type" id="content_type" class="required">
                		...
                		<option value="<?php echo content\models\Content::CONTENT_TYPE_ARTICLE;?>">Article</option>
            ...
            <tr valign="top" id="category-list" style="display:none;">
             ...
             <tr valign="top" id="article-date-row" style="display:none">
            ...
            <tr valign="top">
                    ...
                    <td>
                    <input name="meta_title" id="meta_title" type="text" size="28" value="<?php echo set_value('meta_title') ?>" autocomplete="off" />
                    </td>
                </tr>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <textarea name="meta_description" id="meta_description" rows="5" cols="100" ><?php echo set_value('meta_description') ?></textarea><br />
                ...
                <tr valign="top">
                    ...
                    <td>
                        <textarea name="meta_keyword" id="meta_keyword" rows="5" cols="100" ><?php echo set_value('meta_keyword') ?></textarea><br />
