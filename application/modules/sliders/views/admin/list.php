...
<div class="response info" >You can sort the images using the sorting handle in the actions in each row.</div>
<div class="section">
  <h4>Manage Slider
  <?php //show_pre($sliders);die;?>
  
  <a href="<?php echo admin_url("slider/addslider/$group_id")?>" class="section-button"><span class="ui-icon ui-icon-plusthick"></span><span class="icontext">Add an Image</span></a>
  </h4>
   ...
   <ul class="sort_slider" style="list-style-type:none; width:100%; margin:0 0 0 0;">
    ...
    <tr valign="middle" class="<?php if($sn%2==0) echo 'odd'; else echo 'even';?>" id="sltr_<?php echo $u['id'];?>" >
      ...
      <div class="action-controls">
            <a href="<?php echo admin_url('slider/editslider/'.$u['id'])?>" class="action-button" title="Edit Slider Image"><span class="ui-icon ui-icon-pencil"></span></a>
            <a href="<?php echo admin_url('slider/deleteslider/'.$u['id']);?>" class="action-button delete-image" title="Delete Image"><span class="ui-icon ui-icon-trash"></span></a>
