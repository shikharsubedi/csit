<div class="section">
    ...
    <?php endif ?> 
    <h4>Manage Faculty 
        <a href="<?php echo admin_url("faculty/add") ?>" class="section-button" title="Add new media"><span class="ui-icon ui-icon-plusthick"></span><span class="icontext">Add New Faculty</span></a>
    </h4>                
    <div class="content">
                ...
                <table class="sortable data" cellpadding="0" cellspacing="0">
                    ...
                    <tbody id="toArray">
                        <?php foreach ($faculty as $f): ?> 
                            <tr id="<?php echo $f->getId() ?>">
                                <td><input type="checkbox" name="check[]" value="<?php echo $f->getId(); ?>" class="flag-check"></td>

                                <td><?php echo ucfirst($f->getName()) ?></td> 
                                <td><?php echo $f->getStatus() ? "active" : "inactive" ?></td>
                                <td>
                                    <div class="action-controls">                                        
                                        <a href="<?php echo admin_url("faculty/viewFaculty/" . $f->getId()) ?>" class="action-button" title="View students applied to Faculty"><span class="ui-icon ui-icon-arrowthick-1-ne"></span></a>
                                        <a href="<?php echo admin_url("faculty/edit/" . $f->getId()) ?>" class="action-button" title="Edit Faculty"><span class="ui-icon ui-icon-pencil"></span></a>
                                        <a href="<?php echo admin_url("faculty/delete/" . $f->getId()) ?>" class="action-button delete-image" title="Delete Faculty"><span class="ui-icon ui-icon-trash"></span></a>
                                        <div class="clear"></div>
                                    </div>
                                </td>
                            </tr>
        ...
        <?php else: ?>  
            No items available yet. Start by adding one <a href="<?php echo admin_url("faculty/add") ?>" >here</a>
        <?php endif ?>  
        <div style="clear"></div>
